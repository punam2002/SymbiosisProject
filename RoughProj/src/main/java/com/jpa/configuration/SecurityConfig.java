...
import com.jpa.Service.CustomUserDetailsService;
import com.jpa.Service.CustonSussessHandler;

@Configuration
@EnableWebSecurity
public class SecurityConfig {
	@Autowired 
	CustonSussessHandler customSuccessHandler;
	@Autowired 
	CustomUserDetailsService customStudentDetailsService;
	@Bean
